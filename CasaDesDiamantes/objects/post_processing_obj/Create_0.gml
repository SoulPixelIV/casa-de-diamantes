...
var act5Effects = [
	new FX_Bloom(true, 4, 0.5, 0.95, c_white, 0.3, true, undefined, 0.8, 1, true),
	new FX_SunShafts(true, [0.5, 0.5], 0.4, 0.22, 1.08, 1.6, 0.4, true, 0.7, 0.05, 0.15),
	new FX_ChromaticAberration(true, 0),
];
act5_profile = new PPFX_Profile("Main", act5Effects);
var endCreditsEffects = [
	new FX_Bloom(true, 6, 0.5, 1, c_white, 0.3, true, undefined, 0.8, 1, true),
	new FX_SunShafts(true, [0.5, 0.5], 0.3, 0.43, 0.45, 1.6, 0.4, true, 0.7, 0.05, 0.15),
	new FX_NoiseGrain(true, 0.5),
	new FX_ChromaticAberration(true, 0),
];
...
} else if (room == level_Casino || room == level_DiningHall || room == level_TristramRoom || room == level_Basement || room == level_ConsumedCasino || room == level_BasementConsumed || room == level25 || room == level26 || room == level27 || room == level28) {
