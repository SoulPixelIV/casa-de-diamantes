...
draw_text(global.xScreenSize / 1.3, 110, "Savefile 3");
...
if (file_exists("save3")) {
	...
	draw_text(global.xScreenSize / 1.3, 101 + 32, currSection);
	
	draw_text(global.xScreenSize / 1.3, 101 + 48 + 16, "Deaths " + string(deaths));	
	draw_text(global.xScreenSize / 1.3, 101 + 64 + 16, "Chips " + string(saveMoney));
	draw_text(global.xScreenSize / 1.3, 101 + 80 + 16, "Syringes " + string(saveSyringes));
	draw_text(global.xScreenSize / 1.3, 101 + 96 + 16, "Diamonds " + string(saveDiamonds));
