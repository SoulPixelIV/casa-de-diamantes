...
dialogue[95] = "_Steph!";
dialogue[96] = "#Guys! So happy to see you again! How was the trip?";
dialogue[97] = ";We were not able to find the mother plant.";
dialogue[98] = ">Ah the weather was wonderful!";
dialogue[99] = "#I'm glad you were able to make it here.";
...
dialogue[104] = "}Typical.";
dialogue[105] = "§Next time we'll order an airship.";
dialogue[106] = ";You better be!";
dialogue[107] = "§Anyway, the manager wants to meet you Steph.";
dialogue[108] = "§And we're all invited tonight!";
dialogue[109] = "§So let's meet at the diner.";
...
dialogue[114] = "^I'm glad you like it.";
...
dialogue[120] = "^Steph, your payment is waiting for you.";
dialogue[121] = "^You can talk to one of the staff members.";
dialogue[122] = "#Appreciated.";
dialogue[123] = ";Komo, could you please consume your food like a normal human being.";
dialogue[124] = ">*chomp* Whats your problem??";
dialogue[125] = "$Guys please..";
dialogue[126] = "#Cindy, how do we proceed?";
dialogue[127] = "$I have analyzed your findings.";
dialogue[128] = "$I have found some disturbing evidence for my hypothesis..";
dialogue[129] = "$We will talk about it later in our room.";
dialogue[130] = "$But for now let us enjoy the evening.";
dialogue[131] = ">";
...
dialogue[208] = "$All aggressive beings we met so far seem to be..";
dialogue[209] = "$..at least partially surrounded with plantmatter.";
dialogue[210] = "$Which seems to coincide with the information..";
dialogue[211] = "$..we gathered prior to our arrival here.";
dialogue[212] = "$My guess is, this was caused my some kind of infection.";
dialogue[213] = "$This brings us to my next point,..";
dialogue[214] = "$..for which Tristram prepared something for us.";
dialogue[215] = ";In our search through southeast asia,..";
dialogue[216] = ";..we have confirmed the rumours of the existence of a flower..";
dialogue[217] = ";..capable of growing exclusively out of animal carcasses.";
dialogue[218] = ";Tests have shown to survive, if grafted to living specimen..";
dialogue[219] = ";..even if it lost its ability to grow.";
dialogue[220] = "$My theory suggests it must have fundamentally..";
dialogue[221] = "$..changed it's entire lifecycle and behaviour.";
dialogue[222] = "$I just don't know in what way yet.";
dialogue[223] = ";If there is a link between the species we found in indonesia..";
dialogue[224] = ";..and the one we're dealing with here, it can only mean one thing.";
dialogue[225] = ";Someone is purposefully spreading this species.";
dialogue[226] = ";Only that this scale seems far too big for a group small enough..";
dialogue[227] = ";..to have eluded us this far.";
dialogue[228] = "$Thank you Tristram.";
dialogue[229] = "$Now, what do we do with all this?";
dialogue[230] = "$Well, Tristram and Komo had an idea already.";
dialogue[231] = "$On the plane they saw some kind of powerplant..";
dialogue[232] = "$..that seemed to melt and collapse in on itself.";
dialogue[233] = ">It's as if its walls were burnt away..";
dialogue[234] = ">..with some kind of quickly spreading acid.";
dialogue[235] = ">We're thinking that our evildoers might have abused this facility..";
dialogue[236] = ">..to somehow spread this infection to the masses.";
dialogue[237] = "$Steph, we'll send you and Tristram over there.";
dialogue[238] = "$See what you two can find out!";
dialogue[239] = "$For tonight, you're dismissed! Good night.";
dialogue[240] = "                                                                                                             ";
dialogue[241] = "";
