var enemyTarget = instance_place(x, y, plantWallBoss_obj);
if (!dealtDamage && instance_exists(enemyTarget) && other.hitable)
{
	...
	enemyTarget.hp -= 1 / enemyTarget.damageRes;
	enemyTarget.headshot = false;
	enemyTarget.aggro = true;
	bloodSpread = instance_create_layer(x + random_range(-156, 156), y - 86, "Instances", bloodSpread_obj);
	bloodSpread.image_angle = image_angle;
	bloodSpread2 = instance_create_layer(x + random_range(-156, 156), y - 86, "Instances", bloodSpread2_obj);
