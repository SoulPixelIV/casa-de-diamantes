...
surface_set_target(rain_surface_b);
	...
	repeat(isize) {
		...
		draw_sprite_ext(_drop.sprite, _drop.sprite_subimg, cam_x+_drop.xx, _drop.yy, _drop.scale, _drop.scale, 0, c_white, _drop.alpha);
		++i;
	}
...
surface_set_target(_surf1);
	...
	shader_set_uniform_f(shader_get_uniform(__ppf_sh_ds_box4, "u_resolution"), width, height);
