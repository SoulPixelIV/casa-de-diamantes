...
if (movement)
{
	...
	if (aggro)
	{
		...
		if (changeFlyPosTimer < 0) {
			...
			changeFlyPosTimer = random_range(140, 310);
		}
...
if (hp < 0)
{
	...
	/*
	var stinger = instance_create_layer(x - 12, y, "Instances", moth_objBodyPart_obj);
	stinger.image_index = 0;
	var head = instance_create_layer(x + 6, y - 2, "Instances", moth_objBodyPart_obj);
	head.image_index = 1;
	var leg = instance_create_layer(x - 12, y + 6, "Instances", moth_objBodyPart_obj);
	leg.image_index = 2;
	*/
