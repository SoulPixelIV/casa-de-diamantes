...
if (key_escape && !pauseDelayStart && !enemySlowmo && hp > 0 && !dialogueSystem_obj.inCutscene && camera_obj.blackscreenStrength < 0.1 && !deathActivated && !camera_obj.cameraTrainCutscene && room != level28) {
	save_scr();
