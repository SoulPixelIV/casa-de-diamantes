...
// Generated at 2020-11-17 13:28:21 (9656ms) for v2.3+
...
globalvar mt_gml_class;if(live_enabled)mt_gml_class=new gml_std_haxe_enum(-1,"gml_class");
...
if(live_enabled)function gml_std_string_pos_ext_haxe(this,l_sub,l_startPos){
...
if(live_enabled)function gml_remove_func(l_name){
...
if(live_enabled)function gml_remove_var(l_name){
...
if(live_enabled)function gml_remove_const(l_name){
...
if(live_enabled)function gml_seek_enum_fields_proc_one(l_q,l_st){
	var l__g=l_q;
	if(l__g.__enumIndex__==41){
		var l_f=l__g.h_fd;
		var l_x=l__g.h_x;
...
if(live_enabled)function gml_seek_enum_values_proc_one(l_e){
...
if(live_enabled)function haxe_ds_basic_map_h_remove(l_key){
	var this=self;
	if(variable_struct_exists(self.h_obj,l_key)){
		if(self.h_blanks>0){
...
function gml_class_else(l_q,l_inst){
	if(live_enabled){
		...
		switch(l_q.__enumIndex__){
			case 2:return false;
			case 0:case 1:
				gml_thread_error("Object `"+l_c[1, 0](gml_class_print,l_c)+"` has no fields.");
				return 0;
			case 3:case 4:
				gml_thread_error("Object `"+l_c[1, 0](gml_class_print,l_c)+"` is not an array.");
				return 0;
...
if(live_enabled)function mc_gml_class()constructor{
	static getIndex=method(undefined,gml_std_enum_getIndex);
	static toString=method(undefined,gml_std_enum_toString);
	static __enum__=mt_gml_class;
}

function mc_gml_class_get_field():mc_gml_class()constructor{
	static __enumParams__=[];
	static __enumIndex__=0;
}
globalvar gml_class_get_field;gml_class_get_field=new mc_gml_class_get_field();

function mc_gml_class_set_field():mc_gml_class()constructor{
	static __enumParams__=[];
	static __enumIndex__=1;
}
globalvar gml_class_set_field;gml_class_set_field=new mc_gml_class_set_field();

function mc_gml_class_has_field():mc_gml_class()constructor{
	static __enumParams__=[];
	static __enumIndex__=2;
}
globalvar gml_class_has_field;gml_class_has_field=new mc_gml_class_has_field();

function mc_gml_class_add_index():mc_gml_class()constructor{
	static __enumParams__=[];
	static __enumIndex__=3;
}
globalvar gml_class_add_index;gml_class_add_index=new mc_gml_class_add_index();

function mc_gml_class_get_length():mc_gml_class()constructor{
	static __enumParams__=[];
	static __enumIndex__=4;
}
globalvar gml_class_get_length;gml_class_get_length=new mc_gml_class_get_length();

function mc_gml_class_typeof():mc_gml_class()constructor{
	static __enumParams__=[];
	static __enumIndex__=5;
}
globalvar gml_class_typeof;gml_class_typeof=new mc_gml_class_typeof();

function mc_gml_class_print():mc_gml_class()constructor{
	static __enumParams__=[];
	static __enumIndex__=6;
}
globalvar gml_class_print;gml_class_print=new mc_gml_class_print();
...
if(live_enabled)function gml_value_get_type(l_this1){
	if(l_this1==undefined){
		...
		if(array_length_2d(l_this1,2)==1){
			...
			var l_this2=l_this1;
			return l_this2[1, 0](gml_class_typeof,l_this2);
		} else if(is_array(l_this1)){
			return "array";
		} else return "ref";
	...
	if(l_v==undefined){
		...
		if(array_length_2d(l_v,2)==1){
			...
			if(is_array(l_v[1, 0])){
				...
				var l_this1=l_v;
				return l_this1[1, 0](gml_class_print,l_this1);
			}
		} else {
...
globalvar gml_thread_proc_result_ok;gml_thread_proc_result_ok=new mc_gml_thread_proc_result_ok();

if(live_enabled)function mc_gml_thread_proc_result_error():mc_gml_thread_proc_result()constructor{
	static __enumParams__=[];
	static __enumIndex__=1;
}
globalvar gml_thread_proc_result_error;gml_thread_proc_result_error=new mc_gml_thread_proc_result_error();

if(live_enabled)function mc_gml_thread_proc_result_sync_pos():mc_gml_thread_proc_result()constructor{
	static __enumParams__=[];
	static __enumIndex__=2;
}
globalvar gml_thread_proc_result_sync_pos;gml_thread_proc_result_sync_pos=new mc_gml_thread_proc_result_sync_pos();

if(live_enabled)function mc_gml_thread_proc_result_sync_scope():mc_gml_thread_proc_result()constructor{
	static __enumParams__=[];
	static __enumIndex__=3;
}
globalvar gml_thread_proc_result_sync_scope;gml_thread_proc_result_sync_scope=new mc_gml_thread_proc_result_sync_scope();
