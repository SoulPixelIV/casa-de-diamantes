...
texelW = texture_get_texel_width(sprite_get_texture(casinoBuildingSmall_spr, 0));
texelH = texture_get_texel_height(sprite_get_texture(casinoBuildingSmall_spr, 0));
